...
<div class="card card-secondary">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('jobs.store') }}" method="POST" id="formKirim" files="true" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <label for="name">Jobs</label> 
                    <input type="text" placeholder="Jobs" class="form-control {{ $errors->first('jobs') ? "is-invalid": "" }}" name="jobs" id="jobs" value="{{ old('jobs') }}" />
