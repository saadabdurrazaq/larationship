...
<div class="card card-secondary">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('teachers.store') }}" method="POST" id="formKirim" files="true" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <label for="name">Teachers</label> 
                    <input type="text" placeholder="Teachers" class="form-control {{ $errors->first('teacher') ? "is-invalid": "" }}" name="teacher" id="teacher" value="{{ old('teacher') }}" />
