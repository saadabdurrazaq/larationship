      ...
      <div class="card-body">
        ...
        @foreach($data as $student)
          <tr>
            <td>{{ $student->name }}</td> 
            <td> 
              <a href="{{ route('students.edit-student', $student->id) }}" style="margin-top:5px;" class="btn btn-primary btn-sm">Edit</a> 
              <form class="d-inline" id="#submitDelete" action="{{ route('student.delete-permanent', ['id' => $student->id]) }}" method="POST">
                @csrf 
